...
return [
    ...
    */
    ...
    'public_path' => is_dir(public_path()) ? public_path() : (is_dir(base_path('public_html')) ? base_path('public_html') : (is_dir(base_path('../public_html')) ? base_path('../public_html') : base_path())),
