...
Route::middleware('guest')->group(function () {
    ...
    Route::post('/login', [FrontController::class , 'loginStore'])->name('login.store');
    Route::get('/register', [FrontController::class , 'register'])->name('register');
    Route::post('/register', [FrontController::class , 'registerStore'])->name('register.store');
...
// =========================================================================
// RUTE YANG DI-PROTEKSI DENGAN MIDDLEWARE (WAJIB LOGIN)
// =========================================================================
Route::middleware('auth')->group(function () {
    ...
    // Dashboard utama (bisa diakses semua peran yang login)
    Route::get('/dashboard', [DashboardController::class , 'dashboard'])->name('dashboard');

    // Profil Mandiri Pengguna
    ...
    // API & Halaman Notifikasi Real-time
    ...
    // ---------------------------------------------------------------------
    // GRUP MIDDLEWARE: KHUSUS PERAN ADMIN (peran_id: 1)
    // ---------------------------------------------------------------------
    Route::middleware('peran:admin')->group(function () {
        ...
        // Penyewaan Admin (Verifikasi Pembayaran & Invoice)
        ...
        // Penugasan Admin (Validasi Bukti Selesai Pengiriman Sopir)
        ...
        // Pembatalan Sewa Admin (Verifikasi Refund)
    ...
    // ---------------------------------------------------------------------
    // GRUP MIDDLEWARE: KHUSUS PERAN CLIENT/KLIEN (peran_id: 2)
    // ---------------------------------------------------------------------
    Route::middleware('peran:client')->group(function () {
        // Penyewaan Client (Transaksi & Detail)
        ...
        // Pembayaran Client (Upload Bukti & Riwayat)
    ...
    // ---------------------------------------------------------------------
    // GRUP MIDDLEWARE: KHUSUS PERAN SOPIR (peran_id: 3)
    // ---------------------------------------------------------------------
    Route::middleware('peran:sopir')->group(function () {
        // Penugasan Sopir
