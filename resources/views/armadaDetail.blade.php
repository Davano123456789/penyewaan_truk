    ...
    <div class="min-h-screen bg-gray-50 py-12" style="font-family: 'Poppins', sans-serif;">
        <div class="container mx-auto px-4 max-w-7xl">
            ...
            <a href="{{ route('daftarArmada') }}"
                ...
                <span>Kembali ke Daftar Armada coba</span>
            </a>
                            ...
                            <div>
                                ...
                                <div class="space-y-3 mb-6">
                                    ...
                                    <div class="flex items-center justify-between py-3 border-b border-gray-100">
                                        ...
                                        <span class="text-lg font-semibold text-gray-900">{{ $armada->kapasitas ?? '0' }}
                                            Ton</span>
                                    </div>
                                    ...
                                    <div class="flex items-center justify-between py-3 border-b border-gray-100">
                                        ...
                                        <span
                                            class="text-lg font-semibold text-gray-900">{{ $armada->no_polisi ?? '-' }}</span>
                                    </div>
                ...
                <div class="lg:col-span-1">
                    ...
                    @if($relatedArmadas->count() > 0)
                        <div class="bg-white rounded-xl shadow-sm p-6 sticky top-6">
                                    ...
                                    <a href="{{ route('armada.detail', $related->id) }}" class="block group">
                                        <div class="flex gap-3 p-3 rounded-lg hover:bg-gray-50 transition-colors">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <h3
                                                    class="text-sm font-semibold text-gray-900 mb-1 truncate group-hover:text-blue-600 transition-colors">
                                                    {{ $related->merek ?? 'N/A' }}
                                                </h3>
                                                ...
                                                <div class="flex items-center gap-3 text-xs text-gray-600">
                                                    ...
                                                    <span class="flex items-center gap-1">
                                                        <i
                                                            class="fas fa-circle text-xs {{ $related->status === 'tersedia' ? 'text-green-500' : ($related->status === 'maintenance' ? 'text-amber-500' : 'text-red-500') }}"></i>
                                            ...
                                            <div class="flex-shrink-0 flex items-center">
                                                <i
                                                    class="fas fa-chevron-right text-gray-300 text-xs group-hover:text-blue-600 transition-colors"></i>
                                            </div>
                                        </div>
                                    </a>
                                @endforeach
                            ...
                            <!-- View All Link -->
                            <a href="{{ route('daftarArmada') }}"
                                class="block mt-4 pt-4 border-t text-center text-sm text-blue-600 hover:text-blue-700 font-medium transition-colors">
                                Lihat Semua Armada →
                            </a>
                        </div>
                    @endif
